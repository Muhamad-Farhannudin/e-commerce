  ...
  return (
    <>
      <div className="xl:w-full">
        <div className="max-w-full mx-4 lg:mx-[130px] flex xl:justify-between md:justify-between md:pr-24 items-center py-5">
          ...
          <div className="hidden md:flex items-center xl:w-[665px] md:w-[400px] h-10 border border-blue rounded-md">
          ...
          <div className="xl:flex hidden md:hidden sm:hidden justify-between max-w-[228px] h-10 ml-[89px] cursor-pointer">
