  ...
  return (
    <>
      <div className="w-full h-[324px]">
        <div className="grid grid-rows-1 md:flex justify-between max-w-full mx-4 md:mx-[130px] pt-10">
        ...
        <div className="max-w-full mt-[60px] bottom-0 bg-gray-300">
          <div className="flex justify-between items-center mx-4 md:mx-[130px]">
            <div className="flex items-center justify-center text-[#606060]">
              <FaRegCopyright />
              <p className="font-normal text-base text-[#606060] cursor-pointer hover:text-dark transition-all hover:duration-300 my-5 pl-2">2023 Muhamad Farhannudin ~ Ecommerce.</p>
            </div>
            <div className="flex items-center justify-between w-[107px] cursor-pointer">
