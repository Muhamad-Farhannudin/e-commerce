    ...
    <div className='max-w-full mx-[130px] flex items-center justify-between'>
        <div className='flex items-center justify-between w-1/2 group'>
            <div className='flex items-center w-1/5 justify-evenly group-hover:cursor-pointer'>
                <MdMenu />
                <p className='font-medium text-base text-dark'>All category</p>
            </div>
            <p className='font-medium text-base text-dark group-hover:cursor-pointer'>Hot offers</p>
            <p className='font-medium text-base text-dark group-hover:cursor-pointer'>Gift boxes</p>
            <p className='font-medium text-base text-dark group-hover:cursor-pointer'>Projects</p>
            <p className='font-medium text-base text-dark group-hover:cursor-pointer'>Menu item</p>
            <div className='flex items-center justify-between group-hover:cursor-pointer'>
                <p className='font-medium text-base text-dark'>Help</p>
                <MdExpandMore />
            </div>
        </div>
