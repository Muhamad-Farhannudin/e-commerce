...
export default function Recommended({fetchURL}) {
  ...
  return (
    ...
    <div className='max-w-full mx-4 md:mx-[130px] my-[30px]'>
        <h1 className='font-semibold text-dark text-lg md:text-2xl'>Recommended items</h1>
        <div className='grid grid-cols-2 gap-2 md:flex md:justify-between mt-6 cursor-pointer'>
            {rec.slice(23, 28).map((item) => (
            <div className='w-[180px] flex flex-col items-center pt-2 quote hover:bg-slate-200 transition-all duration-200'>
                <img className='w-[150px] h-[150px]' src={item.images[0]} alt="data" />
                <div className='pl-4'>
