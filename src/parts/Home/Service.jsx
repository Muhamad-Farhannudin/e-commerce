    ...
    <>
      <div className="max-w-full mx-[130px] my-[30px]">
        ...
        <div className="flex justify-between mt-6">
          <div className="w-[280px] h-[200px] rounded-md border border-gray-200 bg-white relative">
            <div className="rounded-t-md w-full h-[120px] bg-dark">
              <img src={imgService1} alt="service-1" />
              <div className="flex items-center justify-center w-[55px] h-[55px] absolute right-5 -translate-y-7 bg-[#D1E7FF] border-2 border-white rounded-full cursor-pointer hover:scale-110 transition duration-700 ease-out hover:shadow-lg">
          ...
          <div className="w-[280px] h-[200px] rounded-md border border-gray-200 bg-white relative">
            <div className="rounded-t-md w-full h-[120px] bg-dark">
              <img src={imgService3} alt="service-3" />
              <div className="flex items-center justify-center w-[55px] h-[55px] absolute right-5 -translate-y-7 bg-[#D1E7FF] border-2 border-white rounded-full cursor-pointer hover:scale-110 transition duration-700 ease-out hover:shadow-lg">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="w-[280px] h-[200px] rounded-md border border-gray-200 bg-white relative">
            <div className="rounded-t-md w-full h-[120px] bg-dark">
              <img src={imgService4} alt="service-4" />
              <div className="flex items-center justify-center w-[55px] h-[55px] absolute right-5 -translate-y-7 bg-[#D1E7FF] border-2 border-white rounded-full cursor-pointer hover:scale-110 transition duration-700 ease-out hover:shadow-lg">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
